...
//        }
        ...
        private static void UpdateAllSceneProbes(ReflectionProbeData data)
        {
            ...
            ReflectionProbe[] probes = GaiaUtils.FindOOTs<ReflectionProbe>();
            if (probes.Length > 0)
            {
        ...
        public static Camera GetCamera(bool checkTag = false)
        {
            ...
            camera = GaiaUtils.FindOOT<Camera>();
            if (camera != null)
            {
                if (checkTag)
                {
        ...
        public static GameObject GetCharacter()
        {
            ...
            CharacterController characterController = GaiaUtils.FindOOT<CharacterController>();
...
#if ENVIRO_HD
            EnviroSkyRendering skyRendering = GaiaUtils.FindOOT<EnviroSkyRendering>();
            if (skyRendering != null)
            {
                GameObject.DestroyImmediate(skyRendering);
            }

            EnviroPostProcessing enviroPostProcessing = GaiaUtils.FindOOT<EnviroPostProcessing>();
...
#if ENVIRO_LW
            EnviroSkyRenderingLW skyRenderingLW = GaiaUtils.FindOOT<EnviroSkyRenderingLW>();
...
#region Adhoc helpers
        ...
        public static Transform GetPlayerTransform()
        {
            ...
            Camera camera = GaiaUtils.FindOOT<Camera>();
            if (camera != null)
            {
