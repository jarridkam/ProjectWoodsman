...
namespace Gaia.Pipeline.HDRP
{
    ...
    public static class GaiaHDRPPipelineUtils
    {
        ...
        public static void CleanUpHDRP(UnityPipelineProfile profile, GaiaSettings gaiaSettings)
        {
            ...
            {
#if HDPipeline
                HDAdditionalCameraData[] camerasData = GaiaUtils.FindOOTs<HDAdditionalCameraData>();
                if (camerasData != null)
                {
                ...
                HDAdditionalLightData[] lightsData = GaiaUtils.FindOOTs<HDAdditionalLightData>();
                if (lightsData != null)
                {
                ...
                HDAdditionalReflectionData[] reflectionsData = GaiaUtils.FindOOTs<HDAdditionalReflectionData>();
        ...
        private static void SetupDefaultSceneLighting(UnityPipelineProfile profile, bool setDayInstead)
        {
            try
            {
                ...
                {
                    Volume sceneVolume = GaiaUtils.FindOOT<Volume>();
                    if (sceneVolume != null)
                    {
        ...
        private static void SetSkyboxAndFog2019_3(GaiaLightingProfileValues profile, VolumeProfile volumeProfile, bool applyProfile = false)
        {
            try
            {
                ...
                {
                    ProceduralWorldsGlobalWeather pwGlobal = GaiaUtils.FindOOT<ProceduralWorldsGlobalWeather>();
                    if (pwGlobal == null)
                    {
